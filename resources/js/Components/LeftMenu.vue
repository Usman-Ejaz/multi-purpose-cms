<template>
    <div data-simplebar="init" class="h-100">
        <div class="simplebar-wrapper" style="margin: 0px;">
                                ...
                                <ul class="metismenu list-unstyled mm-show" id="side-menu">
                                        ...
                                        <ul class="sub-menu mm-collapse" aria-expanded="true">
                                            <li>
                                                ...
                                                <ul class="sub-menu mm-collapse" aria-expanded="true">
                                                    ...
                                                    <li><a href="layouts-icon-sidebar.html" key="t-icon-sidebar">Icon
                                                            Sidebar</a></li>
                                                    <li><a href="layouts-boxed.html" key="t-boxed-width">Boxed Width</a>
                                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu mm-collapse" aria-expanded="false">
                                            ...
                                            <li><a href="ecommerce-add-product.html" key="t-add-product">Add Product</a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu mm-collapse" aria-expanded="false">
                                            ...
                                            <li><a href="invoices-detail.html" key="t-invoice-detail">Invoice Detail</a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu mm-collapse" aria-expanded="false">
                                            ...
                                            <li><a href="projects-overview.html" key="t-p-overview">Project Overview</a>
                                            </li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu mm-collapse" aria-expanded="false">
                                            ...
                                            <li><a href="auth-lock-screen-2.html" key="t-lock-screen-2">Lock Screen 2</a>
                                            </li>
                                            <li><a href="auth-confirm-mail.html" key="t-confirm-mail">Confirm Email</a></li>
                                            <li><a href="auth-confirm-mail-2.html" key="t-confirm-mail-2">Confirm Email
                                                    2</a></li>
                                    ...
                                    <li class="mm-active">
                                        ...
                                        <ul class="sub-menu mm-collapse mm-show" aria-expanded="false">
                                            <li class="mm-active"><a href="pages-starter.html" key="t-starter-page"
                                                    class="active">Starter Page</a></li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu mm-collapse" aria-expanded="false">
                                            ...
                                            <li><a href="ui-session-timeout.html" key="t-session-timeout">Session
                                                    Timeout</a></li>
            ...
            <div class="simplebar-placeholder" style="width: auto; height: 1495px;"></div>
        </div>
        <div class="simplebar-track simplebar-horizontal" style="visibility: hidden;">
            <div class="simplebar-scrollbar" style="transform: translate3d(0px, 0px, 0px); display: none;"></div>
        </div>
        <div class="simplebar-track simplebar-vertical" style="visibility: visible;">
            <div class="simplebar-scrollbar" style="height: 83px; transform: translate3d(0px, 147px, 0px); display: block;">
            </div>
        </div>
    </div>
</template>